...
--
-- Table structure for table `reservtour`
--

DROP TABLE IF EXISTS `reservtour`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `reservtour` (
...
--
-- Dumping data for table `reservtour`
--

LOCK TABLES `reservtour` WRITE;
/*!40000 ALTER TABLE `reservtour` DISABLE KEYS */;
/*!40000 ALTER TABLE `reservtour` ENABLE KEYS */;
UNLOCK TABLES;
