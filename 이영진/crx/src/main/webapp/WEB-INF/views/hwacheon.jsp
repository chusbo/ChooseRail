...
<body>
	...
	<div class="container">
		...
		<div class="subMenu subtle text-center px-2">
			<div class="row">
				<div class="subMenu1 col border border-white ms-1"><a href="hwacheon.do" class="fs-5">화천역</a></div>
	...
	<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=74433c16b1f2a05d5e948ea7cee3126f"></script>
		<script>
			var mapContainer = document.getElementById('map'), // 지도를 표시할 div 
			    mapOption = { 
	    		center: new kakao.maps.LatLng(38.102485276151725,127.7044528987498), // 지도의 중심좌표
	        		level: 3 // 지도의 확대 레벨
	    	};
		...
		// 마커가 표시될 위치입니다 
		var markerPosition  = new kakao.maps.LatLng(38.102485276151725,127.7044528987498); 
